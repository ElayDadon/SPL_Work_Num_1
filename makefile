...
bin/cRace: bin/main.o bin/Agent.o bin/Graph.o bin/Parser.o bin/Party.o bin/Simulation.o bin/Coalition.o EdgeWeightSelectionPolicy.o LastOfferJoinPolicy.o MandatesJoinPolicy.o MandatesSelectionPolicy
	g++ -o bin/cRace bin/main.o bin/Agent.o bin/Graph.o bin/Parser.o bin/Party.o bin/Simulation.o bin/Coalition.o EdgeWeightSelectionPolicy.o LastOfferJoinPolicy.o MandatesJoinPolicy.o MandatesSelectionPolicy
